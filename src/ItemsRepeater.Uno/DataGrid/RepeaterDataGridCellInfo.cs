...
public readonly struct RepeaterDataGridCellInfo : IEquatable<RepeaterDataGridCellInfo>
{
    ...
    public bool Equals(RepeaterDataGridCellInfo other) => RowIndex == other.RowIndex && ColumnIndex == other.ColumnIndex;

    public override bool Equals(object? obj) => obj is RepeaterDataGridCellInfo other && Equals(other);
