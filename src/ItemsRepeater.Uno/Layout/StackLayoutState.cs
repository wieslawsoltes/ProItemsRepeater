...
namespace Avalonia.Layout
{
    public class StackLayoutState
    {
        ...
        private readonly List<double> _estimationBuffer = new();
        private readonly List<LineInfo> _lineCache = new();
        ...
        private FenwickDouble _measuredSizeSum = new(0);
        private FenwickInt _measuredCount = new(0);
        ...
        {
            var estimationBufferIndex = elementIndex % _estimationBuffer.Count;
