    ...
    internal class ViewportManager
    {
            ...
            get
            {
                ...
                if (suggestedAnchor == null)
                {
                    ...
                    if (anchorElement != null)
                    {
                        ...
                        var parent = child.GetVisualParent() as FrameworkElement;
                        ...
                        while (parent != null)
                        {
                            ...
                            child = parent;
                            parent = parent.GetVisualParent() as FrameworkElement;
                        }
                    }
                }
        ...
        public void OnBringIntoViewRequested(RequestBringIntoViewEventArgs args)
        {
            if (!_managingViewportDisabled)
            {
                ...
                var targetChild = args.TargetElement is FrameworkElement targetElement
                    ? GetImmediateChildOfRepeater(targetElement)
                    : null;
                ...
                if (!_isBringIntoViewInProgress)
                {
                    ...
                    _ = _owner.DispatcherQueue?.TryEnqueue(OnCompositionTargetRendering);
                }
            }
        }
        ...
        private void OnEffectiveViewportChanged(object? sender, EffectiveViewportChangedEventArgs e)
        {
            ...
            UpdateViewport(e.EffectiveViewport.ToAvalonia(), invalidateMeasure: true);
