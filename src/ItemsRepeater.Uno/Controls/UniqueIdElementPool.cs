...
{
    internal class UniqueIdElementPool : IEnumerable<KeyValuePair<string, FrameworkElement>>
    {
        private readonly Dictionary<string, FrameworkElement> _elementMap = new Dictionary<string, FrameworkElement>();
        ...
        public FrameworkElement? Remove(int index)
        {
        ...
        public IEnumerator<KeyValuePair<string, FrameworkElement>> GetEnumerator() => _elementMap.GetEnumerator();
